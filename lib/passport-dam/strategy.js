...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || options.authorizationUrl || 'https://auth.darkartmailbox.com/dialog/authorize';
    options.tokenURL = options.tokenURL || options.tokenUrl || 'https://auth.darkartmailbox.com/oauth/token';
    ...
    this._profileURL = options.profileURL || options.profileUrl || 'https://auth.darkartmailbox.com/api/userinfo';
